...
The legacy `_LegacyPathFinder` shim was physically deleted (PR #124, `a76ab1f`). `src/backlink_publisher/__init__.py` is 102 lines (a public SDK facade + a win32 `fcntl` shim) with no legacy import bridge. All imports must use canonical paths:
