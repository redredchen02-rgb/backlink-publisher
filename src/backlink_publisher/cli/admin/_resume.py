...
from backlink_publisher.cli.publish._dedup_gate import gate, is_crashed_in_flight, record_done, record_failure
...
def _revalidate_checkpoint_items(run_id: str, ckpt: dict[str, Any], config: Any) -> None:
    ...
    """
    from backlink_publisher import checkpoint
    from backlink_publisher.validate._payload import _enhance_payload
...
def _emit_noop_resume(ckpt: dict[str, Any], run_id: str) -> None:
    ...
    """
    from backlink_publisher import checkpoint
    from backlink_publisher.events import project_run_safe
...
def _run_resume(args: Any) -> None:
    ...
    from backlink_publisher.cli.publish._dedup_gate import enforce_precondition_or_exit
