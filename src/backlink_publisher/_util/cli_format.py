...
def emit_jsonl(rows: list[dict[str, Any]], file=sys.stdout) -> None:
...
def emit_jsonl_stream(rows: list[dict[str, Any]], file=sys.stdout) -> None:
...
def emit_progress(summary: dict[str, Any], file=sys.stderr) -> None:
...
def emit_error(msg: str, file=sys.stderr) -> None:
