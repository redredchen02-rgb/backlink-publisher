...
def test_token_drift_aborts_mid_run(tmp_path, monkeypatch):
    ...
    with patch("backlink_publisher.cli.admin._resume.adapter_publish", side_effect=fake_publish):
        with patch("backlink_publisher.cli.admin._resume.verify_adapter_setup"):
