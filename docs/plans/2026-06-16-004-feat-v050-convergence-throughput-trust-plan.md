...
**Files:**
- Modify: `docs/plans/2026-06-16-002-feat-comprehensive-optimization-roadmap-plan.md`
...
- **GSC 003 Units 規格來源**: `docs/plans/2026-06-16-003-feat-gsc-indexation-ranking-loop-plan.md`（U5/U6/U7，本計劃不重寫）
...
- Related plans: `docs/plans/2026-06-16-002-feat-comprehensive-optimization-roadmap-plan.md`（M1 Unit 1 對齊對象）、`docs/plans/2026-06-16-003-feat-gsc-indexation-ranking-loop-plan.md`（M1 Unit 2-4 規格來源）
