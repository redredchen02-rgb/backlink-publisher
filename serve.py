...
_DRAFTS_GAP_NOTE = (
    "webui_app/api/v1/drafts.py: the legacy POST /ce:draft/bulk-publish-now "
...
def _resolve_threads() -> int:
    ...
    """
    return int(os.environ.get('WSGI_THREADS', '1'))


def _force_production_debug_off(flask_app) -> None:
