...
from backlink_publisher.idempotency import DedupKey, DedupRecord, DedupStore
...
def enforce_precondition_or_exit() -> None:
    ...
    if not enforce_enabled():
        return
    from backlink_publisher.idempotency.reconcile import ACK_QUARANTINE_ENV, check_enforce_readiness
